...
from .views import (IndexView, DetailView, CategoryView, TagView, AboutView,
                    SilianView, MySearchView, ArchiveView, TimelineView, CommentView, addComment, commentList)
...
urlpatterns = [
    ...
    url(r'^comment/$', CommentView, name='comment'),  # 留言页面
    url(r'^addComment/$', addComment, name='add_comment'),  # 新增留言
    url(r'^commentList/$', commentList, name='comment_list'),  # 查询留言列表

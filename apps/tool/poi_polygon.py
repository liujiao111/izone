...
import apps.tool.area_boundary as  area_boundary
import apps.tool.city_grid as city_grid
import time
...
def get_data(province, city, keyword, coord, key):
    ...
    for grid in grids_lib:
        ...
        print('===================================总的：' + str(len(grids_lib)) + '个网格，还剩' + str(len(grids_lib) - index) + '个网格待爬取, 当前矩形范围：', grid, '总共：',
...
#get_data('ss', '440100', '170200', 2, '4188efb67360681f89110ccdb11e563b')
